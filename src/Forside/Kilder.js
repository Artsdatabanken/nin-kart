...
const ForsideDataleverandør = props => {
  return (
    <div className="frontpage_sources">
      <a href="https://www.miljodirektoratet.no/" className="frontpage_link">
        <img
      ...
      <a href="https://www.kartverket.no" className="frontpage_link">
        <img
      ...
      <a href="https://www.nina.no/" className="frontpage_link">
        <img
      ...
      <br />
      <a href="https://www.nibio.no/" className="frontpage_link">
        <img
      ...
      <a href="https://www.ngu.no/" className="frontpage_link">
        <img
      ...
      <a href="https://www.ssb.no/" className="frontpage_link">
        <img
